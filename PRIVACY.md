...
**ALIS does not intentionally collect personal data about visitors or followers, through either
its website or its publishing integrations.** ALIS code does not request, build or retain their
names, contact details, profile information, device identifiers, IP addresses, location, tracking
profiles, comments, private messages, or follower lists. If someone contacts ALIS voluntarily,
ALIS processes what they send only to answer them, as described above. ALIS runs no advertising and sets no analytics or advertising cookies of its own.
...
Apart from information people voluntarily send us, ALIS does not intentionally hold personal data
about visitors or followers. If you believe
